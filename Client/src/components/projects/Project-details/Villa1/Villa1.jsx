...
import styles from "./Villa1.module.css";
...
const Villa1 = ({isSun}) => {
  ...
  const initialProjects = { id: 'id_01', name: 'Modern Villa A', link: "/projects/Villa-1", type: 'Residential House', image: "Sellables/Lucknow/Villa1/Villa1-01.jpg", bhk: '2 BHK', location: '26.956198954265062, 80.94167949669797, Tiwaripur, Uttar Pradesh 226021', area: '1100 sq ft', price: '₹ 60 Lac', status: 'Ready to move', bedrooms: 2, bathrooms: 2, year_built: 2024, likes: 0, likedBy: [] };
  const images = [
